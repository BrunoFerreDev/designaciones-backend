...
const getArbitrosDesignados = (id) =>
  api.get("/designados", { params: { idDesignacion: id } }).then((r) => r.data);
...
const vincularArancelAutomatico = (idDesignacion) =>
  api
    .put(`/designaciones/${idDesignacion}/vincular-arancel-automatico`)
    .then((r) => r.data);
